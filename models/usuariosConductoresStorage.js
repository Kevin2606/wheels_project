...
__decorate([
    Expose({ name: 'id' }),
    IsNumber({}, { message: () => { throw { status: 406, message: "El formato del parametro es incorrecto: id" }; } }),
    IsNotEmpty({ message: () => { throw { status: 422, message: "Parametro obligatorio: id" }; } }),
    __metadata("design:type", Number)
], UsuarioConductor.prototype, "id", void 0);
__decorate([
    Expose({ name: 'usuario' }),
